...
class AsteriskListener:
    ...
    def init_lisener(self):
        ...
        self.client.run(apps='hello-world')
    ...
    def init_logger(self):
        ...
        self.handler = RotatingFileHandler(self.log_file_name,maxBytes=self.file_size, backupCount=self.back_up_count)
    ...
    def obtain_ari_config(self):
        ...
        try:
            ...
            self.client = ari.connect('http://{host}:{port}/'.format(host=self.ari_host,port=self.ari_port),self.ari_username,self.ari_password)
    ...
    def fetch_from_db(self):
        ...
        try:
            ...
            if len(ans):
                ...
                self.logger.error('User Does Not Exist in Database') 
        except Exception as e:
    ...
    def save_contact_to_hub(self):
        ...
        try:
            ...
            self.logger.debug("Saving contact to hub {}{}{}{}{}".format(self.vid,self.first_name,self.last_name,self.email,self.phone_number))
            ...
            with PortalConnection(authentication_key, self.app_name) as connection:
                ...
                properties={u'lastname':unicode(self.last_name,'utf-8'), u'firstname': unicode(self.first_name,'utf-8'),\
                u'phone':unicode(str(self.phone_number),'utf-8')},))
...
if __name__ == "__main__":
    ...
    asterisk_lisener.init_logger()
    asterisk_lisener.init_lisener()
